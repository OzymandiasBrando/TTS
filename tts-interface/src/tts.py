...
voice_combo = ttk.Combobox(voice_frame, values=voice_names, state="readonly", width=40, font=("Segoe UI", 12, "bold"))
...
info_label = ttk.Label(root, text="Certifique-se que o 'Cable Output' está como saída de comunicação padrão!", style="TLabel")
